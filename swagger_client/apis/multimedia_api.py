...
class MultimediaApi(object):
    ...
    def count_get_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/multimedia/count', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def count_postjson_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/multimedia/count', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def find_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api('/multimedia/find/{id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='MultiMediaObject',
                                        auth_settings=auth_settings,
                                        async=params.get('async'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def find_by_ids_with_http_info(self, ids, **kwargs):
        ...
        return self.api_client.call_api('/multimedia/findByIds/{ids}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='list[MultiMediaObject]',
                                        auth_settings=auth_settings,
                                        async=params.get('async'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_distinct_values_with_http_info(self, field, **kwargs):
        ...
        return self.api_client.call_api('/multimedia/getDistinctValues/{field}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_field_info_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/multimedia/metadata/getFieldInfo', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_paths_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/multimedia/metadata/getPaths', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_settings_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/multimedia/metadata/getSettings', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_settings_0_with_http_info(self, name, **kwargs):
        ...
        return self.api_client.call_api('/multimedia/metadata/getSetting/{name}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def is_operator_allowed_with_http_info(self, field, operator, **kwargs):
        ...
        return self.api_client.call_api('/multimedia/metadata/isOperatorAllowed/{field}/{operator}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def query_get(self, **kwargs):
        ...
        :param async bool
        :return: QueryResultMultiMediaObject
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def query_get_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/multimedia/query', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='QueryResultMultiMediaObject',
                                        auth_settings=auth_settings,
                                        async=params.get('async'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def query_postjson_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/multimedia/query', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
